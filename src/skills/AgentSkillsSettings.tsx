...
export function AgentSkillsSettings({ directoryBase, settings }: { directoryBase: string; settings: ChatSettings }) {
  ...
  return <div className="agent-skills-settings">
    ...
    {!directoryBase ? <div className="settings-warning">A Workspace is required to install skills. <button type="button" className="settings-browse" onClick={() => window.dispatchEvent(new Event("llm-hub:project-required"))}>Select a Workspace directory</button></div> : <>
