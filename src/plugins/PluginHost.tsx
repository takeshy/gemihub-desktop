    ...
    <aside className="plugin-host">
      ...
      <div className="plugin-host-body">
        {aiEnabled && activeTab === "chat" ? (
          <ChatPanel isDark={isDark} directoryBase={directoryBase} projectBase={projectBase} settings={chatSettings} onSettingsChange={onChatSettingsChange} activeFile={activeFile} activeSelection={activeSelection} draftRequest={chatDraftRequest} externalAttachments={chatAttachmentRequest} pluginCommands={slashCommands} onOpenSettings={onOpenChatSettings} onOpenFile={onOpenDirectoryFile} onOpenWorkflow={(path) => { onOpenDirectoryFile(path); setActiveTab("workflow"); }} />
