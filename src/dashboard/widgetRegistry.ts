...
const core: DashboardWidgetDefinition[] = [
  ...
  { type: "calendar", label: "Calendar", description: "Timeline events and posts", defaultConfig: { timelineName: DEFAULT_TIMELINE_NAME }, defaultSize: { w: 6, h: 6 }, configurable: true },
