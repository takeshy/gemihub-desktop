...
const core: DashboardWidgetDefinition[] = [
  ...
  { type: "kanban", label: "Kanban", description: "Board backed by a .kanban definition and Markdown folder", defaultConfig: { kanban: "", folder: "", statusProperty: "status", titleProperty: "title", timelineName: DEFAULT_TIMELINE_NAME, columns: [{ value: "todo", label: "To do" }, { value: "doing", label: "Doing" }, { value: "done", label: "Done" }] }, defaultSize: { w: 8, h: 5 }, filePathKey: "kanban", configurable: true },
  { type: "timeline", label: "Timeline", description: "Personal Markdown microblog", defaultConfig: { name: DEFAULT_TIMELINE_NAME, latestCount: 20, composerMode: "raw" }, defaultSize: { w: 6, h: 6 }, configurable: true },
  { type: "calendar", label: "Calendar", description: "Timeline events and locally created files", defaultConfig: { timelineName: DEFAULT_TIMELINE_NAME, showCreatedFiles: true }, defaultSize: { w: 6, h: 6 }, configurable: true },
