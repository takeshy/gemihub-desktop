...
func (a *App) chatCodexAppServer(request ChatRequest) (*ChatResult, error) {
	...
	if _, err := callCodexRPC(scanner, encoder, 1, "initialize", map[string]any{"clientInfo": map[string]any{"name": "gemihub_desktop", "title": appName, "version": "1.2.0"}}, nil); err != nil {
