...
var workflowNodeDocumentation = map[string]string{
	...
	"rag-sync": "rag-sync: runs a full incremental local RAG sync; optional ragSetting (defaults to selected setting), deprecated path, saveTo.", "file-explorer": "file-explorer: saveTo or savePathTo; optional path, mode select/create, title, extensions, default. Returns FileExplorerData.",
